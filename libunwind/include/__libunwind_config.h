...
#define _LIBUNWIND_HIGHEST_DWARF_REGISTER_LINX 16
#define _LIBUNWIND_HIGHEST_DWARF_REGISTER_LINXV4 24
#define _LIBUNWIND_HIGHEST_DWARF_REGISTER_LINXV5 24
...
#define _LIBUNWIND_CURSOR_SIZE (_LIBUNWIND_CONTEXT_SIZE + 12)
#define _LIBUNWIND_HIGHEST_DWARF_REGISTER _LIBUNWIND_HIGHEST_DWARF_REGISTER_LINX
# elif defined(__linx_v4)
#  define _LIBUNWIND_TARGET_LINXV4 1
#  define _LIBUNWIND_CONTEXT_SIZE 25
#  define _LIBUNWIND_CURSOR_SIZE (_LIBUNWIND_CONTEXT_SIZE + 12)
#  define _LIBUNWIND_HIGHEST_DWARF_REGISTER _LIBUNWIND_HIGHEST_DWARF_REGISTER_LINXV4
# elif defined(__linx_v5)
#  define _LIBUNWIND_TARGET_LINXV5 1
#  define _LIBUNWIND_CONTEXT_SIZE 25
#  define _LIBUNWIND_CURSOR_SIZE (_LIBUNWIND_CONTEXT_SIZE + 12)
#  define _LIBUNWIND_HIGHEST_DWARF_REGISTER _LIBUNWIND_HIGHEST_DWARF_REGISTER_LINXV5
# elif defined(__ve__)
