...
entry:
  %t = call %linx.tile @llvm.linx.tile.tload(ptr %src, i32 6, i32 17, i64 0, i64 8, i64 8, i64 0)
  ; 32*32*1*4B = 4096B, but TSize=3 only allows 512B per PE.
  call void @llvm.linx.tile.tstore(ptr %dst, %linx.tile %t, i32 3, i32 17, i64 0, i64 32, i64 32, i64 0)
  ret void
}

; CHECK: Linx: tile.tstore tile-byte check failed: bytes=4096B
; CHECK: exceeds descriptor limit 512B (TSize=3)
