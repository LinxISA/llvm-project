...
entry:
  %base = call %linx.tile @llvm.linx.tile.tload(ptr %a, i32 8, i32 1, i64 0, i64 8, i64 8, i64 0)
  br i1 %take_load, label %with_load, label %without_load

with_load:
  %extra = call %linx.tile @llvm.linx.tile.tload(ptr %b, i32 8, i32 1, i64 0, i64 8, i64 8, i64 0)
  br label %join
...
join:
  call void @llvm.linx.tile.tstore(ptr %dst, %linx.tile %base, i32 8, i32 1, i64 0, i64 8, i64 8, i64 0)
  ret void
}
