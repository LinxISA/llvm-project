...
entry:
  ...
  ; 16*16*16*4B = 16384B > 8192B strict CUBE output cap.
  %tc = call %linx.tile @llvm.linx.cube.tmatmul(%linx.tile %ta, %linx.tile %tb, i32 16, i32 16, i32 16)
  ret void
}

; CHECK: Linx: cube.tmatmul tile-byte check failed: bytes=16384B
