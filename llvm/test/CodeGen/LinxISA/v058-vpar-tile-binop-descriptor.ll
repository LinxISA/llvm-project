...
entry:
  ...
  %sum = call %linx.tile @llvm.linx.vpar.tadd(%linx.tile %ta, %linx.tile %tb, i32 6)
  call void @llvm.linx.tile.tstore(ptr %dst, %linx.tile %sum, i32 6, i32 1, i64 0, i64 8, i64 8, i64 0)
  ret void
}
...
; OBJ-NEXT:   B.TEXT
; OBJ-NEXT:   B.IOT{{[[:space:]]+}}t#2, t#1, mask=1111, last, ->t<4KB>
; OBJ-NEXT:   C.B.DIMI
...
entry:
  %ta = call %linx.tile @llvm.linx.tile.tload(ptr %a, i32 6, i32 1, i64 0, i64 8, i64 8, i64 0)
  %tb = call %linx.tile @llvm.linx.tile.tload(ptr %b, i32 6, i32 1, i64 0, i64 8, i64 8, i64 0)
  %diff = call %linx.tile @llvm.linx.vpar.tsub(%linx.tile %ta, %linx.tile %tb, i32 6)
  call void @llvm.linx.tile.tstore(ptr %dst, %linx.tile %diff, i32 6, i32 1, i64 0, i64 8, i64 8, i64 0)
  ret void
}
