...
declare <1024 x i32> @llvm.linx.tlsu.tload.shape.v1024i32(
    ptr, i32 immarg, i32 immarg, i64, i64, i64, i32 immarg, i64)
declare void @llvm.linx.tlsu.tstore.shape.v1024i32(
    ptr, <1024 x i32>, i32 immarg, i32 immarg, i64, i64, i64,
    i32 immarg, i64)
declare <1024 x i32> @llvm.linx.tileop.binary.shape.v1024i32(
...
define void @dynamic_rect_add(ptr %lhs, ptr %rhs, ptr %dst,
                              ...
                              i64 %stride) {
entry:
  %a = call <1024 x i32> @llvm.linx.tlsu.tload.shape.v1024i32(
      ptr %lhs, i32 1, i32 0, i64 %valid_col, i64 %valid_row, i64 32,
      i32 6, i64 %stride)
  %b = call <1024 x i32> @llvm.linx.tlsu.tload.shape.v1024i32(
      ptr %rhs, i32 1, i32 0, i64 %valid_col, i64 %valid_row, i64 32,
      i32 6, i64 %stride)
  %sum = call <1024 x i32> @llvm.linx.tileop.binary.shape.v1024i32(
      <1024 x i32> %a, <1024 x i32> %b, i32 0, i32 6, i32 1,
      i64 %valid_col, i64 %valid_row, i64 32)
  call void @llvm.linx.tlsu.tstore.shape.v1024i32(
      ptr %dst, <1024 x i32> %sum, i32 1, i32 0, i64 %valid_col,
      i64 %valid_row, i64 32, i32 6, i64 %stride)
  ret void
}
