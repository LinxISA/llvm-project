...
; ASM: loadi32:
; ASM: v.lw.local [ri0.sd, zero.sd], ->vt.w
...
; ASM: loadi16:
; ASM: v.lh.local [ri0.sd, zero.sd], ->vt.h
...
; ASM: loadi8:
; ASM: v.lb.local [ri0.sd, zero.sd], ->vt.b
...
; ASM: v.lw.local [ri0.sd, zero.sd], ->vt.d
...
; ASM: v.lh.local [ri0.sd, zero.sd], ->vt.d
...
; ASM: v.lh.local [ri0.sd, zero.sd], ->vt.w
...
; ASM: sextloadi8toi64:
; ASM: v.lb.local [ri0.sd, zero.sd], ->vt.d
...
; ASM: sextloadi8toi32:
; ASM: v.lb.local [ri0.sd, zero.sd], ->vt.w
...
; ASM: sextloadi8toi16:
; ASM: v.lb.local [ri0.sd, zero.sd], ->vt.h
...
; ASM: v.lwu.local [ri0.sd, zero.sd], ->vt.d
...
; ASM: v.lhu.local [ri0.sd, zero.sd], ->vt.d
...
; ASM: v.lhu.local [ri0.sd, zero.sd], ->vt.w
...
; ASM: zextloadi8toi64:
; ASM: v.lbu.local [ri0.sd, zero.sd], ->vt.d
...
; ASM: zextloadi8toi32:
; ASM: v.lbu.local [ri0.sd, zero.sd], ->vt.w
...
; ASM: zextloadi8toi16:
; ASM: v.lbu.local [ri0.sd, zero.sd], ->vt.h
...
; MIR: name: loadrri64
; MIR: SIMT_LD 0, %0, 4, %1, 4, 3
; ASM: loadrri64:
; ASM: v.ld.local [ri0.sd, ri1.sd<<3], ->vt.d
...
; MIR: name: loadrri32
; MIR: SIMT_LD 0, %0, 4, %1, 5, 3
; ASM: loadrri32:
; ASM: v.ld.local [ri0.sd, ri1.sw<<3], ->vt.d
...
; MIR: SIMT_LD 0, %0, 4, %1, 4, 4
; ASM: loadrri64shift:
; ASM: v.ld.local [ri0.sd, ri1.sd<<4], ->vt.d
...
; MIR: name: loadscaled
; MIR: SIMT_LDI 0, %0, 4, 3
; ASM: loadscaled:
; ASM: v.ldi.local [ri0.sd, 24], ->vt.d
...
; MIR: SIMT_LDI_U 0, %0, 4, 17
; ASM: loadunscaled:
; ASM: v.ldi.u.local [ri0.sd, 17], ->vt.d
