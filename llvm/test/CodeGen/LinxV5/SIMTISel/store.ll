...
; MIR: name: storei64
; MIR: SIMT_SCAR_SD_GLOBAL %1, 4, %0, 4, $r0, 4, 0, implicit $simt_p
; ASM: storei64:
; ASM: l.sd ri1.sd, [ri0.sd, zero.sd<<3]
...
; MIR: name: storei32
; MIR: SIMT_SCAR_SW_GLOBAL %1, 5, %0, 4, $r0, 4, 0, implicit $simt_p
; ASM: storei32:
; ASM: l.sw ri1.sw, [ri0.sd, zero.sd<<2]
...
; MIR: name: storei16
; MIR: SIMT_SCAR_SH_GLOBAL %1, 6, %0, 4, $r0, 4, 0, implicit $simt_p
; ASM: storei16:
; ASM: l.sh ri1.sh, [ri0.sd, zero.sd<<1]
...
; MIR: name: storei8
; MIR: SIMT_SCAR_SB_GLOBAL %1, 7, %0, 4, $r0, 4, 0, implicit $simt_p
; ASM: storei8:
; ASM: l.sb ri1.sb, [ri0.sd, zero.sd]
...
; MIR: SIMT_SCAR_SW_GLOBAL %1, 4, %0, 4, $r0, 4, 0, implicit $simt_p
; ASM: truncstorei64toi32:
; ASM: l.sw ri1.sd, [ri0.sd, zero.sd<<2]
...
; MIR: SIMT_SCAR_SH_GLOBAL %1, 4, %0, 4, $r0, 4, 0, implicit $simt_p
; ASM: truncstorei64toi16:
; ASM: l.sh ri1.sd, [ri0.sd, zero.sd<<1]
...
; MIR: SIMT_SCAR_SB_GLOBAL %1, 4, %0, 4, $r0, 4, 0, implicit $simt_p
; ASM: truncstorei64toi8:
; ASM: l.sb ri1.sd, [ri0.sd, zero.sd]
...
; MIR: SIMT_SCAR_SH_GLOBAL %1, 5, %0, 4, $r0, 4, 0, implicit $simt_p
; ASM: truncstorei32toi16:
; ASM: l.sh ri1.sw, [ri0.sd, zero.sd<<1]
...
; MIR: SIMT_SCAR_SB_GLOBAL %1, 5, %0, 4, $r0, 4, 0, implicit $simt_p
; ASM: truncstorei32toi8:
; ASM: l.sb ri1.sw, [ri0.sd, zero.sd]
...
; MIR: SIMT_SCAR_SB_GLOBAL %1, 6, %0, 4, $r0, 4, 0, implicit $simt_p
; ASM: truncstorei16toi8:
; ASM: l.sb ri1.sh, [ri0.sd, zero.sd]
...
; MIR: SIMT_SCAR_SD_GLOBAL %2, 4, %0, 4, %1, 4, 0, implicit $simt_p
; ASM: storerri64scaled:
; ASM: l.sd ri2.sd, [ri0.sd, ri1.sd<<3]
...
; MIR: SIMT_SCAR_SD_GLOBAL %2, 4, %0, 4, %1, 5, 0, implicit $simt_p
; ASM: storerrsexti32scaled:
; ASM: l.sd ri2.sd, [ri0.sd, ri1.sw<<3]
...
; MIR: SIMT_SCAR_SD_GLOBAL %2, 4, %0, 4, %1, 1, 0, implicit $simt_p
; ASM: storerrzexti32scaled:
; ASM: l.sd ri2.sd, [ri0.sd, ri1.uw<<3]
...
; MIR: SIMT_SCAR_SD_U_GLOBAL %2, 4, %0, 4, %1, 2, 0, implicit $simt_p
; ASM: storerrzexti16unscaled:
; ASM: l.sd.u ri2.sd, [ri0.sd, ri1.uh]
...
; MIR: SIMT_SCAR_SDI_GLOBAL %1, 4, %0, 4, 1, implicit $simt_p
; ASM: storeriscaled:
; ASM: l.sdi ri1.sd, [ri0.sd, 8]
...
; MIR: SIMT_SCAR_SDI_U_GLOBAL %1, 4, %0, 4, 7, implicit $simt_p
; ASM: storeriunscaled:
; ASM: l.sdi.u ri1.sd, [ri0.sd, 7]
