...
; CHECK:VPAR tadd,   <M: 4, N: 4, K: 1, MR> t#2.reuse, t#1, ->t<512B>
; CHECK:VPAR tadd,   <M: 4, N: 4, K: 1, MR> t#3, t#1, ->t<512B>
; CHECK:VPAR copyout, <M: 4, N: 4, K: 1, MR> t#1, [a2]

; CHECK1:VPAR copyin, <M: 4, N: 4, K: 1, MR> [a0], ->t<512B>
; CHECK1:VPAR copyin, <M: 4, N: 4, K: 1, MR> [a1], ->t<512B>
; CHECK1:VPAR tadd,   <M: 4, N: 4, K: 1, MR> t#2, t#1, ->t<512B>
; CHECK1:VPAR tadd,   <M: 4, N: 4, K: 1, MR> t#3, t#1, ->t<512B>
; CHECK1:VPAR copyout, <M: 4, N: 4, K: 1, MR> t#1, [a2]
