...
; CHECK: TMATMUL <M: 16, N: 16, K: 16, FP32, FP32> t#2, t#1, ->acc<1KB>
; CHECK: ACCCVT NZ2ND.canon, <Row: 16, Col: 16, FP32, FP32> acc#1, ->t<1KB>
...
entry:
  ...
  %2 = tail call <256 x float> @llvm.linx.blk.matmul.v256f32.v256f32.v256f32(i64 16, i64 16, i64 16, i64 1, i64 1, <256 x float> %0, <256 x float> %1)
  %3 = tail call <256 x float> @llvm.linx.blk.acccvt.v256f32.v256f32(i64 16, i64 16, i64 1, i64 1, i64 27, i64 1, <256 x float> %2)
