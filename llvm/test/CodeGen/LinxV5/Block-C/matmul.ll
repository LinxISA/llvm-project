...
define void @foo(ptr %p) {
  ...
  %m = call <1024 x float> @llvm.linx.blk.matmul.v1024f32.v1024f32.v1024f32(i64 32, i64 32, i64 32, i64 1, <1024 x float> %a, <1024 x float> %b)
...
declare <1024 x float> @llvm.linx.blk.matmul.v1024f32.v1024f32.v1024f32(i64, i64, i64, i64, <1024 x float>, <1024 x float>)
