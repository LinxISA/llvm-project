; RUN: not llc < %s -enable-all-vector-as-tilereg=true -mcpu=janus --march=linx64v5 -linxv5-enable-clock-hand-opt=false -O2 2>&1 | FileCheck %s --dump-input always -vv --check-prefixes=CHECK

; CHECK: error: unknown token in expression
; CHECK: BSTART.CUBE TMATMUL, FP64
; CHECK: B.IOR [a0],[]
