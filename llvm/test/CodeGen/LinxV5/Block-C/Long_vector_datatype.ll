...
; CHECK: MCALL.PAR       copyin, <M: 1, N: 1, K: 1>      [a0],   ->t<512KB>
; CHECK: MCALL.PAR       copyin, <M: 1, N: 1, K: 1>      [a1],   ->t<512KB>
; CHECK: VCALL.PAR       tadd,   <M: 1, N: 1, K: 1>      t#2, t#1,       ->t<512KB>
; CHECK:MCALL.PAR       copyout,        <M: 1, N: 1, K: 1>      t#1, [a2]
