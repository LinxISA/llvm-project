...
; CHECK: TMATMUL.BIAS        <M: 4, N: 4, K: 1, TF32>        t#3.reuse, t#2.reuse, t#1,      ->acc<512B>
; CHECK: TMATMUL.ACC      <M: 4, N: 4, K: 1, TF32>        t#3, t#2, acc#1,        ->acc<512B>
; CHECK: ACCCVT  NORM.normal, <Row: 4, Col: 4, FP32, FP64>   acc#1,  ->t<512B>
...
entry:
  ...
  %3 = tail call <64 x double> @llvm.linx.blk.matmul.ac.v64f64.v64f64.v64f64.v64f64(i64 4, i64 4, i64 1, i64 2, <64 x double> %0, <64 x double> %1, <64 x double> %2)
  %4 = tail call <64 x double> @llvm.linx.blk.matmul.ac.v64f64.v64f64.v64f64.v64f64(i64 4, i64 4, i64 1, i64 2, <64 x double> %0, <64 x double> %1, <64 x double> %3)
...
declare <16 x double> @llvm.linx.blk.matmul.ac.v16f64.v16f64.v16f64.v16f64(i64, i64, i64, i64, <16 x double>, <16 x double>, <16 x double>)
...
; CHECK:       TMATMULMX        <M: 4, N: 4, K: 1, TF32, HF32>  t#5.reuse, t#4.reuse, t#3.reuse, t#2.reuse,     ->acc<512B>
; CHECK:       TMATMULMX.BIAS      <M: 4, N: 4, K: 1, TF32, HF32>  t#5, t#4, t#3, t#2, t#1,        ->acc<512B>
; CHECK:       ACCCVT  NORM.normal, <Row: 4, Col: 4, FP32, FP64>       acc#1,  ->t<512B>
...
; CHECK:       VPAR    copyin, <M: 4, N: 4, K: 1, MR>   [a2],  ->t<512B>
; CHECK:       VPAR    copyin, <M: 4, N: 4, K: 1, MR>   [a3],  ->t<512B>
; CHECK:       TMATMULMX        <M: 4, N: 4, K: 1, TF32, HF32>  t#4.reuse, t#3.reuse, t#2.reuse,        ->acc<512B>
; CHECK:       TMATMULMX.BIAS      <M: 4, N: 4, K: 1, TF32, HF32>  t#4, t#3, t#2, t#1,     ->acc<512B>
; CHECK:       ACCCVT  NORM.normal, <Row: 4, Col: 4, FP32, FP64>       acc#1,  ->t<512B>
