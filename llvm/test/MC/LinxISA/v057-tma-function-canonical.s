# RUN: llvm-mc -triple=linx64 -filetype=obj %s -o - | llvm-objdump -d --triple=linx64 - | FileCheck %s
	...
	.text
	.globl	test_v057_tma_function_canonical
	.type	test_v057_tma_function_canonical,@function
test_v057_tma_function_canonical:
	BSTART.TLOAD FP16
	BSTART.TSTORE FP16
	BSTART.TMOV FP16
	...
	C.BSTOP
	.size	test_v057_tma_function_canonical, .-test_v057_tma_function_canonical

# CHECK-LABEL: <test_v057_tma_function_canonical>:
