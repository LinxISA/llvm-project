# RUN: llvm-mc -triple=linx64 -filetype=obj %s -o - | llvm-objdump -d --triple=linx64 - | FileCheck %s
	...
	.text
	.globl	test_v056_reserved_encoding_reject
	.type	test_v056_reserved_encoding_reject,@function
test_v056_reserved_encoding_reject:
	...
	.long 0x0000e101
	.size	test_v056_reserved_encoding_reject, .-test_v056_reserved_encoding_reject

# CHECK-LABEL: <test_v056_reserved_encoding_reject>:
