...
# P0-2: raw B.IOT destination words with SizeCode 0 / 11..15 must fail to
# decode (the Local contract is 1..10). Bytes are stored big-endian-ish as
...
# SizeCode=11 (128KB)  -> reserved for B.IOT (Local) -> must be <unknown>
.byte 0x13, 0xde, 0x05, 0x00
# SizeCode=12 (256KB)  -> reserved for B.IOT (Local) -> must be <unknown>
