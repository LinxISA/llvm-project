...
static unsigned MatchLinxV5TileRegisteName(StringRef Name) {
  return StringSwitch<unsigned>(Name.lower())
      ...
      // Absolute physical Tile register spellings are emitted by LLVM's
      // register printer when a long-lived inline-asm Tile operand remains in
      // Tile_ABS after allocation. They use the same six-bit encodings as the
      // output-stack spellings above; accepting both forms makes the emitted
      // assembly round-trip through the integrated assembler.
      .Case("tile_t1", LinxV5::Tile_T1)
      .Case("tile_t2", LinxV5::Tile_T2)
      .Case("tile_t3", LinxV5::Tile_T3)
      .Case("tile_t4", LinxV5::Tile_T4)
      .Case("tile_t5", LinxV5::Tile_T5)
      .Case("tile_t6", LinxV5::Tile_T6)
      .Case("tile_t7", LinxV5::Tile_T7)
      .Case("tile_t8", LinxV5::Tile_T8)
      .Case("tile_t9", LinxV5::Tile_T9)
      .Case("tile_t10", LinxV5::Tile_T10)
      .Case("tile_t11", LinxV5::Tile_T11)
      .Case("tile_t12", LinxV5::Tile_T12)
      .Case("tile_t13", LinxV5::Tile_T13)
      .Case("tile_t14", LinxV5::Tile_T14)
      .Case("tile_t15", LinxV5::Tile_T15)
      .Case("tile_t16", LinxV5::Tile_T16)
      .Case("tile_u1", LinxV5::Tile_U1)
      .Case("tile_u2", LinxV5::Tile_U2)
      .Case("tile_u3", LinxV5::Tile_U3)
      .Case("tile_u4", LinxV5::Tile_U4)
      .Case("tile_u5", LinxV5::Tile_U5)
      .Case("tile_u6", LinxV5::Tile_U6)
      .Case("tile_u7", LinxV5::Tile_U7)
      .Case("tile_u8", LinxV5::Tile_U8)
      .Case("tile_u9", LinxV5::Tile_U9)
      .Case("tile_u10", LinxV5::Tile_U10)
      .Case("tile_u11", LinxV5::Tile_U11)
      .Case("tile_u12", LinxV5::Tile_U12)
      .Case("tile_u13", LinxV5::Tile_U13)
      .Case("tile_u14", LinxV5::Tile_U14)
      .Case("tile_u15", LinxV5::Tile_U15)
      .Case("tile_u16", LinxV5::Tile_U16)
      .Case("tile_m1", LinxV5::Tile_M1)
      .Case("tile_m2", LinxV5::Tile_M2)
      .Case("tile_m3", LinxV5::Tile_M3)
      .Case("tile_m4", LinxV5::Tile_M4)
      .Case("tile_m5", LinxV5::Tile_M5)
      .Case("tile_m6", LinxV5::Tile_M6)
      .Case("tile_m7", LinxV5::Tile_M7)
      .Case("tile_m8", LinxV5::Tile_M8)
      .Case("tile_m9", LinxV5::Tile_M9)
      .Case("tile_m10", LinxV5::Tile_M10)
      .Case("tile_m11", LinxV5::Tile_M11)
      .Case("tile_m12", LinxV5::Tile_M12)
      .Case("tile_m13", LinxV5::Tile_M13)
      .Case("tile_m14", LinxV5::Tile_M14)
      .Case("tile_m15", LinxV5::Tile_M15)
      .Case("tile_m16", LinxV5::Tile_M16)
      .Case("tile_n1", LinxV5::Tile_N1)
      .Case("tile_n2", LinxV5::Tile_N2)
      .Case("tile_n3", LinxV5::Tile_N3)
      .Case("tile_n4", LinxV5::Tile_N4)
      .Case("tile_n5", LinxV5::Tile_N5)
      .Case("tile_n6", LinxV5::Tile_N6)
      .Case("tile_n7", LinxV5::Tile_N7)
      .Case("tile_n8", LinxV5::Tile_N8)
      .Case("tile_n9", LinxV5::Tile_N9)
      .Case("tile_n10", LinxV5::Tile_N10)
      .Case("tile_n11", LinxV5::Tile_N11)
      .Case("tile_n12", LinxV5::Tile_N12)
      .Case("tile_n13", LinxV5::Tile_N13)
      .Case("tile_n14", LinxV5::Tile_N14)
      .Case("tile_n15", LinxV5::Tile_N15)
      .Case("tile_n16", LinxV5::Tile_N16)
