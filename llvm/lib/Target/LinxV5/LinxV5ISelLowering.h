...
enum NodeType : unsigned {
  ...
  BLK_MATMULMX_AC,
  BLK_MATMULMXB_AC,
  // v5: TMATMUL with a Shared Right operand (32-bit B.IOS binder, B not in B.IOT).
  BLK_MATMUL_SHARED,
  BLK_TLOAD,
  BLK_TSTORE,
  BLK_ACCCVT,
...
private:
  ...
  // Right operand is bound by the 32-bit B.IOS at MC expansion, never a B.IOT source.
