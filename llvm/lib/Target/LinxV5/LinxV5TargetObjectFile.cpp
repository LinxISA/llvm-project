//===-- LinxV5TargetObjectFile.cpp - LinxV5 Object Info -----------------===//
//
...
void LinxV5ELFTargetObjectFile::Initialize(MCContext &Ctx,
...
bool LinxV5ELFTargetObjectFile::isInSmallSection(uint64_t Size) const {
...
// section.
bool LinxV5ELFTargetObjectFile::isGlobalInSmallSection(
...
MCSection *LinxV5ELFTargetObjectFile::SelectSectionForGlobal(
...
void LinxV5ELFTargetObjectFile::getModuleMetadata(Module &M) {
