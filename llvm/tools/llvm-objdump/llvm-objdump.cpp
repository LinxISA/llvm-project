...
class LINX64V4PrettyPrinter : public PrettyPrinter {
public:
  void printInst(MCInstPrinter &IP, const MCInst *MI, ArrayRef<uint8_t> Bytes,
                 object::SectionedAddress Address, formatted_raw_ostream &OS,
                 StringRef Annot, MCSubtargetInfo const &STI, SourcePrinter *SP,
...
class LINX64V5PrettyPrinter : public PrettyPrinter {
public:
  void printInst(MCInstPrinter &IP, const MCInst *MI, ArrayRef<uint8_t> Bytes,
                 object::SectionedAddress Address, formatted_raw_ostream &OS,
                 StringRef Annot, MCSubtargetInfo const &STI, SourcePrinter *SP,
...
LINX64V5PrettyPrinter LINX64V5PrettyPrinterInst;
...
PrettyPrinter &selectPrettyPrinter(Triple const &Triple) {
  ...
  case Triple::linx64v4be:
    return LINX64V4PrettyPrinterInst;
  case Triple::linx64v5:
  case Triple::linx64v5be:
    return LINX64V5PrettyPrinterInst;
  }
}
}
...
static void disassembleObject(const Target *TheTarget, ObjectFile &Obj,
  ...
  for (const SectionRef &Section : ToolSectionFilter(Obj)) {
    ...
    DisAsm->processSymbolsBeforeDisasm(Symbols);
