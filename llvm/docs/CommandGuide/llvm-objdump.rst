...
.. option:: -M, --disassembler-options=<opt1[,opt2,...]>
  ...
  * ``no-tile-macros``: LinxV5 only. Do not fold complete TileOp bundles into a single macro instruction; print the underlying physical block micro-instructions instead.
