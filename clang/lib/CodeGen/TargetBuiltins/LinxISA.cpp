...
llvm::Value *CodeGenFunction::EmitLinxISABuiltinExpr(unsigned BuiltinID,
  ...
  case LinxISA::BI__builtin_linx_tile_tload: {
    ...
    llvm::Function *F =
        CGM.getIntrinsic(llvm::Intrinsic::linx_tma_tload_shape, {TileTy});
  ...
  case LinxISA::BI__builtin_linx_tile_tstore: {
    ...
    llvm::Function *F = CGM.getIntrinsic(llvm::Intrinsic::linx_tma_tstore_shape,
                                         {Tile->getType()});
    return Builder.CreateCall(
  ...
  case LinxISA::BI__builtin_linx_tile_tmov: {
    ...
    llvm::Function *F = CGM.getIntrinsic(llvm::Intrinsic::linx_tile_tmov_legacy,
                                         {Src->getType()});
  ...
  case LinxISA::BI__builtin_linx_tepl_unary: {
    ...
    llvm::Function *F = CGM.getIntrinsic(llvm::Intrinsic::linx_tepl_unary_shape,
                                         {Src->getType()});
    return Builder.CreateCall(
  ...
  case LinxISA::BI__builtin_linx_tepl_binary: {
    ...
    llvm::Function *F = CGM.getIntrinsic(
        llvm::Intrinsic::linx_tepl_binary_shape, {A->getType()});
    return Builder.CreateCall(
  ...
  case LinxISA::BI__builtin_linx_tepl_binary_scalar: {
    ...
    llvm::Function *F = CGM.getIntrinsic(
        llvm::Intrinsic::linx_tepl_binary_scalar_shape, {A->getType()});
    return Builder.CreateCall(
        F,
  ...
  case LinxISA::BI__builtin_linx_tepl_splat: {
    ...
    llvm::Type *TileTy = ConvertType(E->getType());
    llvm::Function *F =
        CGM.getIntrinsic(llvm::Intrinsic::linx_tepl_splat_shape, {TileTy});
    return Builder.CreateCall(
  ...
  case LinxISA::BI__builtin_linx_vpar_tadd: {
    ...
    llvm::Function *F = CGM.getIntrinsic(llvm::Intrinsic::linx_vpar_tadd_legacy,
                                         {A->getType()});
  ...
  case LinxISA::BI__builtin_linx_vpar_tsub: {
    ...
    llvm::Function *F = CGM.getIntrinsic(llvm::Intrinsic::linx_vpar_tsub_legacy,
                                         {A->getType()});
